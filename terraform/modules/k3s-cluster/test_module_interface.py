#!/usr/bin/env python3
"""
Property Test: Module Interface Contract for k3s-cluster module
...
def test_module_interface_contract():
    ...
    required_vars = [
        'instance_ip', 'ssh_private_key', 'environment', 'k3s_version'
    ]
    ...
    required_outputs = ['cluster_ready', 'kubeconfig_path']
    ...
    assert 'resource "null_resource" "k3s_install"' in main_content, \
        "K3s install resource not defined"
